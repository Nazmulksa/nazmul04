...
\033[1;94mFACEBOOK MD NAZMUL HASAN 
                  
\033[1;92mFB PAGE   NAZMUL HASAN
...
def action():
    ...
    if peak =='':
        ...
        print '\033[1;92mEnter any code 017 019 018 016 '
        for i in numm:
            print('x' * i)
        try:
...
\033[1;95mFb\033[1;97mNazmulksa"""
